...
//        Locate the elements of email text box, password text box, and sign in button
//        Email
...
//        Assert.assertTrue(isSignOut1);
         ...
         * It returns true if element is existed, it returns false if element is not exist on the page
         *
         *
         * */
    }
